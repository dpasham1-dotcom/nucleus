  ...
  return (
    ...
    >
      <div className="flex flex-col h-full px-4 py-6">
        ...
        <p className="text-[10px] font-body text-center mb-5 opacity-30">
          Press <kbd className="px-1 py-0.5 rounded bg-black/5 mx-0.5 font-mono">/</kbd> to capture
        </p>
          ...
          {NAV_ITEMS.map((item) => {
            ...
            return (
              <button
                ...
                className="w-full py-2.5 px-3 rounded-xl flex items-center gap-3 transition-all group relative"
                style={{
        ...
        <div className="pt-4 border-t border-black/5 space-y-1">
          <button
            ...
            className="w-full py-2.5 px-3 rounded-xl flex items-center gap-3 hover:bg-black/[0.03] transition-all"
          >
          ...
          {/* User Profile */}
          <div className="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-black/[0.03] transition-all">
            {user?.picture ? (
              <img 
                src={user.picture} 
                alt={user.name}
